...
def disk_event():
    return {
        "Error": "RuntimeError",
        "Cause": "{\"errorMessage\":\"{'errorName': 'Error: checking snapshot copy status for forensic idfe89115d-d830-41a0-80b4-e46e9a516a42', 'errorDescription': 'Error while checking snapshot status DISK acquisition - Instance Copy Snapshot', 'errorPhase': 'ACQUISITION', 'errorComponentId': 'checkCopySnapShotStatus', 'errorComponentType': 'Lambda', 'eventData':'', 'IsolationRequired': False, 'appAccount': '123456', 'copySnapshotIds': ['snap-03d40f49a0af4e46f', 'snap-0bcfcce0e0949f2a4'], 'forensicId': 'fe89115d-d830-41a0-80b4-e46e9a516a42','forensicType': 'DISK'} \"}",
    }
...
def memory_event():
    return {
        "Error": "RuntimeError",
        "Cause": "{\"errorMessage\":\"{'errorName': 'Error: checking snapshot copy status for forensic idfe89115d-d830-41a0-80b4-e46e9a516a42', 'errorDescription': 'Error while checking snapshot status DISK acquisition - Instance Copy Snapshot', 'errorPhase': 'ACQUISITION', 'errorComponentId': 'checkCopySnapShotStatus', 'errorComponentType': 'Lambda', 'eventData':'', 'IsolationRequired': False, 'appAccount': '123456', 'copySnapshotIds': ['snap-03d40f49a0af4e46f', 'snap-0bcfcce0e0949f2a4'], 'forensicId': 'fe89115d-d830-41a0-80b4-e46e9a516a42','forensicType': 'MEMORY' }\"}",
    }
